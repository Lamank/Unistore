...
73	1	2022-12-12	2022-12-12	2	6
75	2	2022-12-12	2022-12-12	2	8
\.
...
1	pbkdf2_sha256$320000$ChHzRvpWzkhb29ViWCNBTc$vOR+apDi0TKRrox0U9kAdyCcqB8kPncJqw58qPTPxYo=	2022-12-11 18:49:30.765208+00	t	admin			t	t	2022-11-19 12:33:04.147946+00	admin@gmail.com
\.
...
SELECT pg_catalog.setval('public.users_cartitem_id_seq', 75, true);
...
SELECT pg_catalog.setval('public.users_order_id_seq', 24, true);
...
SELECT pg_catalog.setval('public.users_orderitem_id_seq', 38, true);
