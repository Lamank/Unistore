...
1	Macbook pro	Macbook pro	4859.99	macbook-pro	12	2022-11-19	macOS				\N		\N	\N	1	1	\N	1	\N	uploads/2022/11/19/MacBook_Pro_16_3.jpg	Macbook pro	Macbook pro	Macbook pro	Macbook pro	\N
...
SELECT pg_catalog.setval('public.product_logo_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.product_product_tags_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.product_screen_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.product_tag_id_seq', 3, true);
