...
23	hhfhf	2022-12-15 13:03:05.919931+00	3	\N	9
24	okay	2022-12-15 13:03:16.050305+00	3	12	9
\.
...
194	1	2022-12-15	2022-12-15	2	7
199	1	2022-12-15	2022-12-15	2	8
200	1	2022-12-15	2022-12-15	2	11
193	2	2022-12-15	2022-12-15	2	6
\.
...
9	aaaaa	\N	f	lamankk	Laman	Kalbiyeva	f	f	2022-12-13 14:17:44+00	l.kelbiyeva@gmail.com
1	pbkdf2_sha256$320000$ChHzRvpWzkhb29ViWCNBTc$vOR+apDi0TKRrox0U9kAdyCcqB8kPncJqw58qPTPxYo=	2022-12-15 07:59:40.72117+00	t	admin			t	t	2022-11-19 12:33:04.147946+00	admin@gmail.com
3	pbkdf2_sha256$320000$VpOp9aRjAgmioVI08i9Y1E$ZVSloKJP5A9fmg1o9PeI4IkshY9yVF3dU9wwnvng5Ew=	2022-12-15 14:26:03.205005+00	f	lamank	Laman	Kalbiyeva	f	t	2022-12-07 06:18:07+00	lamankalbiyeva@gmail.com
\.
...
SELECT pg_catalog.setval('public.product_productreview_id_seq', 24, true);
...
SELECT pg_catalog.setval('public.users_cart_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.users_cartitem_id_seq', 200, true);
...
SELECT pg_catalog.setval('public.users_order_id_seq', 45, true);
...
SELECT pg_catalog.setval('public.users_orderitem_id_seq', 76, true);
...
SELECT pg_catalog.setval('public.users_wishlist_id_seq', 22, true);
